class RefineVibeCode < Formula
  ...
  url "https://files.pythonhosted.org/packages/e3/0b/f3a829389b1ffbe40063911f98d9df1c9a3bc2fc5e9c9bc23f630e8bc1e2/refine_vibe_code-0.1.3.tar.gz"
  ...
  def install
    ...
    bin.install_symlink libexec/"bin/refine-vibe-code" => "refine" if (libexec/"bin/refine-vibe-code").exist?
  end
